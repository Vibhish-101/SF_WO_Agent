...
def fetch_orch_items(sf, customer_order):
    ...
    vlocity_cmt__OrchestrationItemId__r.vlocity_cmt__OrchestrationPlanId__r.vlocity_cmt__AccountId__r.SmartNID_Enabled__c,
...
def normalize_records(records):
    ...
    for record in records:
        normalized_record = {
            ...
            "SmartNID": record.get("vlocity_cmt__OrchestrationItemId__r", {}).get("vlocity_cmt__OrchestrationPlanId__r", {}).get("vlocity_cmt__AccountId__r", {}).get("SmartNID_Enabled__c"),
