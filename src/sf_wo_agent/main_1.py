...
import logging
from crew_1 import initialize_environment, initialize_agents, initialize_tasks, Orch_Crew
...
def run():
    ...
    try:
        ...
        inputs = {"customer_order": "A00706991"}  # Example input; customize as needed
